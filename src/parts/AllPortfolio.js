        ...
        <Tabs className="flex flex-col px-4">
          <TabList>
            <div className="flex flex-row mb-5">
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-theme-light-blue text-lg border border-theme-light-blue rounded-full transition duration-300 hover:bg-theme-light-blue hover:text-white focus:outline-none focus:bg-theme-light-blue focus:text-white">Mobile</button>
              </Tab>
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-theme-light-blue text-lg border border-theme-light-blue rounded-full transition duration-300 hover:bg-theme-light-blue hover:text-white focus:outline-none focus:bg-theme-light-blue focus:text-white">Website</button>
              </Tab>
              <Tab>
                <button className="font-normal px-8 py-2 text-theme-light-blue text-lg border border-theme-light-blue rounded-full transition duration-300 hover:bg-theme-light-blue hover:text-white focus:outline-none focus:bg-theme-light-blue focus:text-white">UI/UX</button>
              </Tab>
            </div>
          </TabList>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 sm:gap-2 xl:gap-8 justify-items-center">
              {
                mobile.map((item, index) => (
                  <Fade triggerOnce direction="up" delay={500 * index} key={index}>
                    <Button type="link" href={`/cloud/${item.id}`}>
